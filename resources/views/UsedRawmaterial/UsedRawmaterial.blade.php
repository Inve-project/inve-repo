...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Used raw material</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li><a href="{{url('ListUsedRawmaterial')}}"><button class="btn btn-secondary btn-sm">Go Back</button></a></li>
            </ol>
          </div>
        </div>
      </div>
   ...
   <div class="col-md-8">
      ...
      <div class="card card-primary">
         <!-- form start -->
         <form  method="POST" action="{{url('AddUsedRawmaterial')}}"class="row g-3">
            @csrf
            <div class="card-body">
